...
def main(database, workload, op_counts):
    ...
    for record_count in record_counts:
        ...
        with open(f"../results/workload{workload}/output_load_{record_count}.txt", "w") as fin:
        ...
        for op_count in op_counts:
            for thread in threads:
                ...
                with open(f"../results/workload{workload}/output_run_{record_count}_{op_count}_{thread}.txt", 'w') as fin2:
